...
public class UserController {
    ...
    public ResponseEntity<Utilisateur> insertUser() throws Exception{
        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
        Date date = dateFormat.parse("2005-02-02");
        Utilisateur user = new Utilisateur(0,"Danielle", "Lafatra", date, "Daniella@gmail.com", "0346254879", "Mahamasina", "1234");
